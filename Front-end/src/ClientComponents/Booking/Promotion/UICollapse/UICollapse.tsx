      ...
      children: (
        <div className={clsx(styles.promotionContent)}>
          ...
          <div className={clsx(styles.promotionTransaction)}>
            ...
            <span className={clsx(styles.range)}>tối thiểu là 20 điểm</span> và{" "}
            <span className={clsx(styles.range)}>tối đa là 100 điểm.</span>
          </div>

          <div className={clsx(styles.promotionAccumulation)}>
            Điểm Stars là điểm tích lũy dựa trên giá trị giao dịch bởi thành
            viên giao dịch tại Forest Cinema. Cơ chế tích lũy Stars, như sau:
          </div>
