  ...
  const getMenuItems = () => {
    ...
    menuItems = [
      ...
      getItem("check-in-out", "sub999", <CalendarOutlined />, [
        getItem(<Link to="checkin">Quản lý trạng thái</Link>, "sub999-1"),
      ]),
      getItem("Quản lý phim", "sub2", <VideoCameraAddOutlined />, [
        ...
        getItem(<Link to="calendarShow">Danh sách lịch chiếu</Link>, "sub2-3"),
        getItem(<Link to="showtimes">Danh sách suất chiếu</Link>, "sub2-4"),
        getItem(<Link to="genre">Thể loại phim</Link>, "sub2-5"),

        getItem(<Link to="stoppedMovie">Phim ngừng chiếu</Link>, "sub2-6"),
      ]),
      getItem("Phòng chiếu & Giá vé", "sub5", <DesktopOutlined />, [
        getItem(<Link to="rooms">Danh sách phòng chiếu</Link>, "sub5-1"),
        getItem(<Link to="ticketsPrice">Danh sách giá vé</Link>, "sub5-2"),
      ]),
