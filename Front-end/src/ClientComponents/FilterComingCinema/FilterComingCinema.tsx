...
import { filterComingSoonMoviesByGenre, fetchComingSoonMovies } from "../../services/comingfilm.service";
...
const FilterComingCinema = ({ onFilterChange, onFilteredDataChange }: FilterComingCinemaProps) => {
