...
const ForgotPassword = () => {
  ...
  const onSubmitForgotPassword = async (data: ForgotPasswordFormData) => {
    setLoading(true);
    try {
      console.log('[ForgotPassword Component] Sending Forgot Password Request:', data);
      const response = await authService.forgotPassword(data);
      console.log('[ForgotPassword Component] Forgot Password API Response:', response);
      ...
      message.error(error.message || 'Gửi yêu cầu thất bại. Vui lòng kiểm tra email và thử lại.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleResendOtp = async () => {
    ...
    try {
      console.log('[ForgotPassword Component] Sending Resend OTP Request:', { email });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      console.log('[ForgotPassword Component] Sending Reset Password Request:', { 
        email, 
        otp, 
        hasNewPassword: true 
      });
      ...
      console.log('[ForgotPassword Component] Reset Password Success:', response);
      ...
      let errorMsg = error.message || 'Đặt lại mật khẩu thất bại. Vui lòng thử lại.';
      
      // Xử lý thông báo lỗi cụ thể từ response
      if (error.response?.new_password && Array.isArray(error.response.new_password)) {
