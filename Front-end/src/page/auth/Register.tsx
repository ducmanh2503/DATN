...
const Register = () => {
  ...
  const handleRegister = async (e: React.FormEvent, role: 'admin' | 'customer' = 'customer') => {
    e.preventDefault();
    setLoading(true);
    ...
    try {
      ...
      if (error.message?.includes('Connection could not be established')) {
        errorMessage = 'Hệ thống không thể gửi email xác thực. Vui lòng kiểm tra email và thử lại sau.';
        ...
        <Button className="social-button google-button" type="default" size="large">
          <div className="button-content">
            <svg className="google-icon" viewBox="0 0 24 24" width="24" height="24">
              ...
              <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.60 3.3-4.53 6.16-4.53z" fill="#EA4335" />
            </svg>
