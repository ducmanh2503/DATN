...
import {
    ...
    BarcodeOutlined,
    FileTextOutlined,
    AppstoreOutlined, // Thêm icon cho đơn hàng
...
const SiderAdmin = () => {
    ...
    const getMenuItems = () => {
        ...
        menuItems = [
            ...
            getItem("Quản lý Khuyến Mãi", "sub7", <BarcodeOutlined />, [
                getItem(<Link to="combo">Danh sách combo</Link>, "sub7-1"),
                getItem(<Link to="discount-code">Mã giảm giá</Link>, "sub7-2"),
            ]),
            ...
            getItem("Quản lý người dùng", "sub9", <TeamOutlined />, [
                ...
                getItem(<Link to="actors">Danh sách diễn viên</Link>, "sub9-3"),
            ]),
