...
const SiderAdmin = () => {
  ...
  const items: MenuItem[] = [
    ...
    getItem("Quản lý bài viết ", "sub11", <BarChartOutlined />, [
      getItem(<Link to="articlelist">Danh sách bai viet </Link>, "sub11-1"),
      getItem(<Link to="update-article">chinh sua bai viet </Link>, "sub12-1"),
      getItem(<Link to="create-article">them bai viet </Link>, "sub13-1"),
    ]),
    getItem("Quản lý phiếu giảm giá  ", "sub12 ", <BarChartOutlined />, [
      getItem(<Link to="article">Danh sách bai viet </Link>, "sub14-1"),
    ]),
  ];
  return (
    <div>
